...
public class DemoSafetyCenterFragment extends Fragment {

    Context context;
    private FragmentSafetyCenterBinding fragmentSafetyCenterBinding;

    public DemoSafetyCenterFragment(){
        //Empty constructor
    }

    public static DemoSafetyCenterFragment newInstance() {
        Bundle args = new Bundle();
        DemoSafetyCenterFragment fragment = new DemoSafetyCenterFragment();
    ...
    private class ScreenSlidePagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            return DemoSafetySinglePageFragment.newInstance(position);
        }
