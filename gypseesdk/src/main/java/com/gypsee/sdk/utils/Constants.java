...
//    public static String HARSH_BRAKING = "Please brake gently and safely so that both you and your vehicle are safe.";
    ...
    public static String HARSH_BRAKING_HINDI = "कठोर ब्रेकिंग का पता चला: धीरे ब्रेक करें; टायर, ब्रेक और लागत बचाएं।";
    ...
    public static String ABOVE_ECO_SPEED = "Fuelburn mode: Slow down; save diesel and reduce pollution.";
    ...
    public static String ABOVE_ECO_SPEED_HINDI = "डीजल बर्न मोड: धीमे चलें; डीजल बचाएं और प्रदूषण कम करें।";
    ...
    public static String ECO_SPEED =  "Diesel save mode: Great job! Maintain the same speed for saving diesel, and protecting the environment.";
    ...
    public static String ECO_SPEED_HINDI = "डीजल बचत मोड: शानदार काम! डीजल बचाने और पर्यावरण की सुरक्षा के लिए गति बनाए रखें।";
    ...
    public static String HARSH_ACC = "Rapid Acceleration Detected: Accelerate gently; save engine and diesel.";
    ...
    public static String HARSH_ACC_HINDI = "अचानक गति बढ़ाना: धीरे गति बढ़ाएं; इंजन और डीजल बचाएं।";
    public static String HARSH_ACC_MARATHI = "कृपया हळूवारपणे आणि सुरक्षितपणे वेग वाढवा जेणेकरून तुम्ह  ी आणि तुमचे वाहन दोघेही सुरक्षित राहाल.";
    ...
    public static String OVER_SPEED_HINDI = "अत्यधिक गति का पता चला: धीमे चलें; सुरक्षित रहें और दुर्घटनाओं से बचें।";
    ...
    public static String tripStartedMsgHindi = "यात्रा शुरू हो गई है। फ्यूल शाइन के साथ सुरक्षित और कुशलता से ड्राइव करें।";
